...
{
    // Characters
    public static GameObject BLUE_MASTER_PREFAB;
    public static GameObject PINK_MASTER_PREFAB;
    public static GameObject BLUE_TANK_PREFAB;
    public static GameObject PINK_TANK_PREFAB;
    public static GameObject BLUE_SHOOTER_PREFAB;
    public static GameObject PINK_SHOOTER_PREFAB;
    public static GameObject BLUE_RUNNER_PREFAB;
    public static GameObject PINK_RUNNER_PREFAB;
    public static GameObject BLUE_MECHANIC_PREFAB;
    public static GameObject PINK_MECHANIC_PREFAB;
    public static GameObject BLUE_MEDIC_PREFAB;
    public static GameObject PINK_MEDIC_PREFAB;
